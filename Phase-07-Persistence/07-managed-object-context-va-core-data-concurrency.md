---
title: "Managed Object Context và Core Data concurrency"
phase: "Persistence"
difficulty: 5
importance: 5
...
competencies:
  ...
  - "Interview"
tags:
  - "managed-object-context-va-core-data-concurrency"
  - "global-commerce"
---
...
Trong Global Commerce, Commerce hiển thị dữ liệu account cũ hoặc mất cart offline vì storage được chọn theo thói quen thay vì policy. Chapter này tập trung vào **Managed Object Context và Core Data concurrency**: không dừng ở syntax/API mà nối behavior với ownership, failure mode và evidence production.
...
- [Core Data mental model](06-core-data-mental-model.md); không lặp lại định nghĩa nền nếu chapter trước đã giải thích.
- [Glossary](../GLOSSARY.md) cho terminology canonical.

## Used Later { data-search-exclude }

- [SwiftData và ranh giới availability](08-swiftdata-va-ranh-gioi-availability.md) dùng contract của chapter này làm building block.
...
Domain intent → repository → local transaction/source of truth ↔ synchronization policy
                 ↓
Focus: Managed Object Context và Core Data concurrency
                 ↓
...
Trọng tâm của **Managed Object Context và Core Data concurrency** là: storage được chọn theo data shape, lifetime, query, security và migration. Hãy mô tả bằng state transition, lifetime hoặc output quan sát được thay vì chỉ bằng keyword.
...
1. Observable behavior nào định nghĩa Managed Object Context và Core Data concurrency?
...
Disk I/O, context/transaction và migration có lifecycle riêng; synchronous work sai chỗ có thể block UI. Với **Managed Object Context và Core Data concurrency**, hãy log hoặc đo transition ở boundary thay vì suy luận từ UI cuối cùng.
...
Feature Commerce áp dụng **Managed Object Context và Core Data concurrency** trong flow có network, UI lifecycle và cache.
...
> **Myth:** Chỉ cần dùng đúng API/pattern tên **Managed Object Context và Core Data concurrency** là code an toàn.
>
...
**Hỏi:** Managed Object Context và Core Data concurrency giải quyết vấn đề gì?
...
Viết một ví dụ nhỏ minh họa **Managed Object Context và Core Data concurrency** và test happy path lẫn edge case.
...
Bug report: repeated Commerce flow tạo symptom liên quan **Managed Object Context và Core Data concurrency**. Thu evidence bằng migration/read-write/failure tests, vẽ owner/state graph, xác định root cause và thêm regression test.
...
- [Core Data mental model](06-core-data-mental-model.md)
- [SwiftData và ranh giới availability](08-swiftdata-va-ranh-gioi-availability.md)
